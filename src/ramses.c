...
#ifndef EDUKE32
    tileCreate(kTileRamsesWorkTile, kSpiritX * 2, kSpiritY * 2);
    worktile = (uint8_t *)waloff[kTileRamsesWorkTile];
#else
...
#ifndef EDUKE32
    tilesizx[kTileRamsesWorkTile] = kSpiritY * 2;
    tilesizy[kTileRamsesWorkTile] = kSpiritX * 2;
#else
...
#ifndef EDUKE32
    memset(worktile, -1, (kSpiritY * 2) * (kSpiritX * 2));
#else
...
#ifndef EDUKE32
            short nTileSizeX = tilesizx[nTile];
            short nTileSizeY = tilesizy[nTile];
#else
